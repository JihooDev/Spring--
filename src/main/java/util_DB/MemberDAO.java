...
public class MemberDAO {
	...
	public List<MemberVO> memberList() {
		// sql="select id,password,name,lev,birthd,point,weight, if(lev='A', '관리자', if (lev='B', '나무', if (lev='C', '잎새', if (lev='D', '새싹', '일반')))) 회원등급 from member order by name ";  // 순서대로 정렬 asc(기본값)/desc
